...
class metaFrame():
    ...
    def __init__(self,movieId, userId ,window,Bigwindow,Allwindow,type="base",**kw):
        ...
        self.src, self.title, self.date, self.genres, self.briefinfo = \
            metaFun_GUI.get_src(self.url_imdbid,self.movieId)  # 爬得电影海报的scr等信息
    ...
    def createmovieinfo(self):
        ...
        TkinterGUI.movieInfo_window.movieinfo_window(self.Allwindow, self.movieId, self.userId)
        print("Done!")
